...
uvx nrp-cmd create record --repository $REPOSITORY --model detectors ./sipm_001.json --set sipm_001_draft
...
uvx nrp-cmd upload file @sipm_001_draft --key 01 ./sipm_001.xsdst "$file_metadata" --log-request --repository $REPOSITORY
...
# publish the record
uvx nrp-cmd publish record @sipm_001_draft --repository $REPOSITORY